...
function Navbar() {
    ...
    return (
        <React.Fragment>
            <nav className="navbar navbar-expand-lg bg-dark border-bottom border-bottom-dark ms-0 bg-padding-x" data-bs-theme="dark">
                    <div className="container-fluid">
                    <h1><Link to='/' className='navbar-brand me-auto logo'>WorkConnect</Link></h1>
