...
const Section3 = () => {
    return (
        ...
        <div className='row py-5 px-3 my-3 my-lg-5 px-md-4 px-lg-5 flex-rr flexx light-grey gx-5'>
                    <div className="col-lg"><img src="https://images.pexels.com/photos/5899079/pexels-photo-5899079.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className='img-addrr' /></div>
                    <div className="col-lg">
                        <h3 className='small-heading mt-3 mt-lg-0'>COMPANIES</h3>
