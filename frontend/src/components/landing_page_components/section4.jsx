    ...
    return (
        <div className='row py-5 my-3 my-lg-5 py-5 px-3 px-md-4 px-lg-5 flex-r flexx'>
                    <div className='col-lg'>
                        <h3 className='small-heading mt-3 mt-lg-0'>DEVELOPERS</h3>
                    ...
                    <div className='col-lg'><img src="https://images.pexels.com/photos/7688460/pexels-photo-7688460.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" /></div>
        </div>
    )
}
